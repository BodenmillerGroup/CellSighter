...
# import merged results created with many2one.py
df <- read.csv(paste0(mount_path,"immucan_volume/processed_data/Panel_1/CellSighter/Multiclass/merged_results.csv"))
df$X <- NULL
```
